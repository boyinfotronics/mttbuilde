  ...
  render () {
    return (
      <Router userstore={Userstore} registerStore={RegisterStore}>
          ...
          <Scene key='presentationScreen' component={PresentationScreen} type={'reset'} title='Muang Thong Thani' hideNavBar={false} renderLeftButton={NavItems.hamburgerButton}/>
          ...
          <Scene key='listviewDynamic' component={ListViewDynamic} type={ActionConst.REPLACE} title='Muang Thong Thani'renderLeftButton={NavItems.hamburgerButton}  renderRightButton={NavItems.refreshButton}/>
          <Scene key='listviewDynamic2' component={ListViewDynamic} type={ActionConst.REPLACE} title='Muang Thong Thani' renderLeftButton={NavItems.hamburgerButton} renderRightButton={NavItems.refreshButton1}/>
